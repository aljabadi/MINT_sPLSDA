...
{\centering \includegraphics[width=1\linewidth]{MINT_Data_Integration_files/figure-latex/1-screeplots-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{MINT_Data_Integration_files/figure-latex/1-pca10x-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{MINT_Data_Integration_files/figure-latex/1-pcacelseq-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{MINT_Data_Integration_files/figure-latex/1-pcadropseq-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{MINT_Data_Integration_files/figure-latex/1-pcaCombinedByCellline-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{MINT_Data_Integration_files/figure-latex/1-pcaCombinedByBatch-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{MINT_Data_Integration_files/figure-latex/1-MINTplots1-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{MINT_Data_Integration_files/figure-latex/1-perfPlot-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{MINT_Data_Integration_files/figure-latex/1-sMINTplots1-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{MINT_Data_Integration_files/figure-latex/1-sMINTtunedPlot-1} 
...
{\centering \includegraphics[width=0.95\linewidth]{MINT_Data_Integration_files/figure-latex/1-sMINTtunedPartial-1} 
...
\begin{center}\includegraphics[width=0.5\linewidth]{MINT_Data_Integration_files/figure-latex/1-roc-1} \end{center}
...
\begin{center}\includegraphics[width=0.5\linewidth]{MINT_Data_Integration_files/figure-latex/1-roc-2} \end{center}
...
{\centering \includegraphics[width=0.55\linewidth]{MINT_Data_Integration_files/figure-latex/2-perfPlot10x-1} 
...
{\centering \includegraphics[width=0.65\linewidth]{MINT_Data_Integration_files/figure-latex/2-MINTplots-1} 
...
{\centering \includegraphics[width=0.65\linewidth]{MINT_Data_Integration_files/figure-latex/2-MINTplots2-1} 
...
{\centering \includegraphics[width=0.65\linewidth]{MINT_Data_Integration_files/figure-latex/2-splsdaPlots1-1} 
...
{\centering \includegraphics[width=0.65\linewidth]{MINT_Data_Integration_files/figure-latex/2-splsdaPlots2-1} 
...
{\centering \includegraphics[width=0.55\linewidth]{MINT_Data_Integration_files/figure-latex/2-loadings1-1} 
...
{\centering \includegraphics[width=0.55\linewidth]{MINT_Data_Integration_files/figure-latex/2-loadings2-1} 
...
{\centering \includegraphics[width=0.55\linewidth]{MINT_Data_Integration_files/figure-latex/2-loadings3-1} 
...
{\centering \includegraphics[width=0.65\linewidth]{MINT_Data_Integration_files/figure-latex/2-loadings4-1} 
...
{\centering \includegraphics[width=0.65\linewidth]{MINT_Data_Integration_files/figure-latex/2-loadingscomp2-1} 
...
{\centering \includegraphics[width=0.55\linewidth]{MINT_Data_Integration_files/figure-latex/unnamed-chunk-7-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{MINT_Data_Integration_files/figure-latex/2-vilolinplotPositive-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{MINT_Data_Integration_files/figure-latex/2-vilolinplotNegative-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{MINT_Data_Integration_files/figure-latex/2-vilolinplotPositive-c2-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{MINT_Data_Integration_files/figure-latex/2-vilolinplotNegative-c2-1} 
...
\NormalTok{HCC827_DEtable =}\StringTok{ }\NormalTok{HCC827_DEtable[}\KeywordTok{row.names}\NormalTok{(HCC827_DEtable) }\OperatorTok{%in%}\StringTok{ }\NormalTok{list.intersect,]}
\NormalTok{H2228_DEtable =}\StringTok{ }\NormalTok{H2228_DEtable[}\KeywordTok{row.names}\NormalTok{(H2228_DEtable) }\OperatorTok{%in%}\StringTok{ }\NormalTok{list.intersect,]}
\NormalTok{H1975_DEtable =}\StringTok{ }\NormalTok{H1975_DEtable[}\KeywordTok{row.names}\NormalTok{(H1975_DEtable) }\OperatorTok{%in%}\StringTok{ }\NormalTok{list.intersect,]}
...
\NormalTok{DE.MINT =}\StringTok{ }\NormalTok{DEtable[(DEtable}\OperatorTok{$}\NormalTok{gene }\OperatorTok{%in%}\StringTok{ }\NormalTok{MINT.Combined.vars),]}
